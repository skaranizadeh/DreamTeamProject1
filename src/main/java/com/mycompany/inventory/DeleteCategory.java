...
public class DeleteCategory extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jInternalFrame1.setTitle("Confirm Delete");
        ...
        jButton1.setBackground(new java.awt.Color(150, 80, 82));
        ...
        jLabel1.setText("<html><center>You are about to delete the " + catType + " \"<em>" + catName + "</em>\". Did you mean to perform this action?<br><br>Press \"<em>Delete</em>\" to delete the " + catType + ", or \"<em>Cancel</em>\" to cancel and return to the previous window.");
